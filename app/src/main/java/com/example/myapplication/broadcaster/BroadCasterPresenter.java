...
import com.example.myapplication.rtc_peer.kurento.KurentoPresenterRTCClient;
...
public class BroadCasterPresenter extends MvpBasePresenter<BroadCasterView>
    ...
    public void initPeerConfig() {
        rtcClient = new KurentoPresenterRTCClient(socketService,application.getApplicationContext());
    ...
    public void startCall() {
        ...
        //여기서 ServerHandshake가 안들어가는 것 같다 그쟈?
                ...
                try {
                    ...
                    switch (serverResponse.getIdRes()) {
                        ...
                        case CHAT_RESPONSE:
                            RxScheduler.runOnUi(o -> {
                                if (isViewAttached()) {
                                    Log.d("Viewer", "Presenter!! " +serverResponse.getMessage());
                                    getView().updateRecyclerView(serverResponse.getMessage());
                                    Log.d("Viewer", "Updated RecyclerView!! " +serverResponse.getMessage());
                                }
                            });
                            break;
